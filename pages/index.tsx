    ...
    <div className="flex min-h-screen flex-col items-center justify-center py-2">
      ...
      <main className="flex w-full flex-1 flex-col items-center justify-center px-20 text-center">
        ...
        <p className="mt-3 text-2xl">
          Automated model compression for deep learning.
        </p>

        <div className="mt-6 mb-6 flex max-w-4xl flex-wrap items-center justify-around sm:w-full">
          ...
          <a className="mt-6 w-96 rounded-xl border p-6 text-left hover:bg-gray-100">
            ...
            <p className="mt-4 text-xl">
              ...
              It should be a 
              <code className='rounded-md bg-gray-100 p-1 m-1 font-mono text-lg'>.pt</code> or <code className='rounded-md bg-gray-100 p-1 m-1 font-mono text-lg'>.pth</code> file.
            </p>
          </a>
          ...
          <a className="mt-6 w-96 rounded-xl border p-6 text-left hover:bg-gray-100">
            ...
            <p className="mt-4 text-xl">
              This file contains the architecture of your model.
              It should be a
      ...
      <footer className="flex h-24 mt-6 w-full items-center justify-center border-t">
        <a className="flex items-center justify-center gap-2">
          Thesis Project by Abel Van Steenweghen
        </a>
      </footer>
    </div>
  )
